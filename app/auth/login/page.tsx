    ...
    <main className="min-h-screen grid place-items-center bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 p-4">
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="card-gradient p-8 space-y-6">
          <div>
            <h2 className="text-2xl font-bold bg-gradient-to-r from-primary-600 to-accent-600 bg-clip-text text-transparent">Einloggen</h2>
            <p className="text-sm text-gray-600 mt-1">Mit E-Mail und Passwort oder Social Login</p>
          </div>
          {error ? (
          ...
          {success === "signup" ? (
            <div className="text-sm text-green-600">
              Bitte E-Mail bestätigen, um dich anzumelden.
            </div>
          ) : null}
          {success === "magic" ? (
            <div className="text-sm text-green-600">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <button
                type="submit"
                className="w-full border-2 border-gray-200 rounded-lg py-2.5 bg-white hover:border-primary-500 hover:bg-primary-50 transition-all font-medium flex items-center justify-center gap-2"
              >
          ...
          <div className="space-y-3">
            ...
            <form action={sendPasswordReset} className="flex gap-2">
              ...
              <button
                type="submit"
                className="px-4 py-2.5 border-2 border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-all font-medium whitespace-nowrap"
              >
                Passwort vergessen?
              </button>
            </form>
        ...
        <div className="card-gradient p-8">
          <div className="mb-6">
            <h2 className="text-2xl font-bold bg-gradient-to-r from-accent-600 to-pink-600 bg-clip-text text-transparent">Registrieren</h2>
            <p className="text-sm text-gray-600 mt-1">
              Neue Organisation wird automatisch erstellt
            </p>
          </div>
